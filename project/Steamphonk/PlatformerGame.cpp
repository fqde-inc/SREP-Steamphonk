        ...
        switch (currentShake)
            {
                ...
                case Shakes::STEAMPHONK:
                    duration   = 1;
                    value      = 15.0f;
                    break;
                
                case Shakes::EPILECTIC_DELIGHT:
                    duration   = 1.75f;
                    value      = 30.0f;
                    break;
                
                case Shakes::ULTRAKILL:
                    duration   = 2;
                    value      = 40.0f;
                    break;

                case Shakes::CLOVIS_FRIDAY_NIGHT:
                    duration   = 2.5f;
                    value      = 60.0f;
                    break;
            }
...
void PlatformerGame::render() {
    ...
    if(currentScene == Scenes::MAIN_MENU) {
        ...
        if(ImGui::Button("How to play", {280, 55})) {
            currentScene = Scenes::HOW_TO_PLAY;
            Mix_PlayChannel(-1, startGameSFX, 0);
        }
        ImGui::PopStyleColor();
        ImGui::PopFont();
        ...
        if(ImGui::Button(buttonLabel, {280, 55})) {
            ...
            switch (shakeOption) {
                case Shakes::MILD_LITTLE_PONY:
                    shakeOption = Shakes::STEAMPHONK;
                    break;
                case Shakes::STEAMPHONK:
                    shakeOption = Shakes::EPILECTIC_DELIGHT;
                    break;
                case Shakes::EPILECTIC_DELIGHT:
                    shakeOption = Shakes::ULTRAKILL;
                    break;
                case Shakes::ULTRAKILL:
                    shakeOption = Shakes::CLOVIS_FRIDAY_NIGHT;
                    break;
                case Shakes::CLOVIS_FRIDAY_NIGHT:
                    shakeOption = Shakes::MILD_LITTLE_PONY;
                    break;
            }
        }
        ImGui::PopStyleColor();
        ...
        return;
    } else if (currentScene == Scenes::HOW_TO_PLAY) {
