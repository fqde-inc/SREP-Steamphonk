...
public:
    ...
    void initTileTest(std::string tileName, std::shared_ptr<sre::SpriteAtlas> spriteAtlas, int x, int y, int startSpriteId, int height);
    void initTile(std::shared_ptr<sre::SpriteAtlas> singleSpriteAtlas, int pixelX, int pixelY);
